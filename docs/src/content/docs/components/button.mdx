...
export default () => {
  return (
    <Space>
      ...
      <Button status="danger" icon={<DeleteOutlined />}>
        删除
      </Button>
    </Space>
  );
  ...
  return (
    <Space direction="vertical">
      ...
      <Space>
        ...
        <Button type="secondary" status="primary">
          次要按钮
        </Button>
        <Button type="outline" status="primary">
          线框按钮
        </Button>
      </Space>
      <Space>
...
<code src="~demos/button/loading-status.tsx" />
