...
const Header = () => {
  return (
    <header className="h-header z-10 px-6 bg-yike-1 flex items-center border-b border-yike-1 flex-shrink-0 fixed top-0 inset-x-0">
      <div className="flex items-center">
        <Image width={36} height={28} src={logo} alt="logo" />
        <Link className="text-lg font-semibold ml-3" href="/">
          Yike Design React
        </Link>
      </div>
      {/* TODO: search */}
